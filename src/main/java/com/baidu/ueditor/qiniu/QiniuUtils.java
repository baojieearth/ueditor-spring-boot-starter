...
public class QiniuUtils {
    ...
    public static String upload(MultipartFile file, String fileName) {
        ...
        String accessKey = EditorController.editorProperties.getQiniu().getAccessKey();
        String secretKey = EditorController.editorProperties.getQiniu().getSecretKey();
        String bucket = EditorController.editorProperties.getQiniu().getBucket();
        try {
            ...
            try {
                ...
                return EditorController.editorProperties.getQiniu().getCdn() + putRet.key;
    ...
    public static List<String> listFile(String prefix, int index, int size, Total total) {
        ...
        return Arrays.stream(items).skip(index).limit(size).map(fileInfo -> EditorController.editorProperties.getQiniu().getCdn() + fileInfo.key).collect(Collectors.toList());
    }
